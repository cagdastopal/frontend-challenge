  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {language === 'TR'
            ? translations.TR.header.skills
            : translations.EN.header.skills}
        </a>
        ...
        >
          {language === 'TR'
            ? translations.TR.header.projects
            : translations.EN.header.projects}
        </a>
        ...
        >
          {language === 'TR'
            ? translations.TR.header.hireMe
            : translations.EN.header.hireMe}
        </a>
      </nav>
    </header>
  );
